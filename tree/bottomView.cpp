// WE HAVE TO GIVE OR PRINT THE DATA SUCH WAY WE ARE SEEING THE TREE FROM THE   BOTTOM OF TREE , IN THIS SENARIO ONLY WE ARE USING LEVEL ORDER TRAVERSAL AND EACH INDEX FROM ROOT NODE LEFT TO RIGHT WE WILL ONLY PRINT FIRST ELEMENT BECAUSE OTHER ELEMENT IN EACH VERTICAL LINE WILL BE HIDEEN BY FIRST NODE OF THAT VERTICAL LINE
#include <iostream>
#include <vector>
#include <queue>
#include <map>
...
{
    node *root = buildTree();
    cout << "Printing tree from Bottom View....." << endl;
